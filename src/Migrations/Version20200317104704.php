 ...
 */
final class Version20200317104704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE personne (id INT NOT NULL, num_cpte_banque VARCHAR(255) NOT NULL, nom_pe VARCHAR(255) DEFAULT NULL, prenom_pe VARCHAR(255) DEFAULT NULL, adresse_pe VARCHAR(255) DEFAULT NULL, telephone_pe INT DEFAULT NULL, code_postal INT DEFAULT NULL, nom_ville VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, login VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, anniv DATE DEFAULT NULL, tel_banque INT DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE locataire (id INT NOT NULL, id_banque_id INT DEFAULT NULL, num_appart_id INT DEFAULT NULL, PRIMARY KEY(id))');
